...
| **Classifiers**                 | **Accuracy achieved** | **F1_Score achieved** |
|---------------------------------|-----------------------|-----------------------|
| `nltk.NaiveBayesClassifier`     | _94.01%_              | _54.02%_              |
| `Random_Forest_Classifier`      | _95.06%_              | _60.02%_              |
| `Logistic_Regression`           | _93.20%_              | _59.33%_              |
| `Decision_Tree_Classifier`      | _93.20%_              | _53.70%_              |
| `SVC`                           | _95.21%_              | _49.86%_              |
| `XGB_Classifier`                | _95.55%_              | _57.48%_              |
